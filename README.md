...
Having demonstrated that we are able to use cGAN to differentially generate female and male faces on the basis of embedding labels, the question is, can we use cGAN to differentially generate images where the patterns of the disease are evident in x-rays.  
