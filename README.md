...
<p align="center"> 
<img src="/images/attractivex-rays.png" width="650" height="135">
</p>
...
There are four kinds of embedding and the identity of the embedding (0 thru 3) is included in the generated x-ray. In many ways, those x-rays identified as being 0 are "healthy lungs".  Those x-rays identified as 0 (healthy), are clearly male.  Those x-rays identifed as 2 are female with high cheek bones.  Feature 3 identifies those x-rays which supposedly have large lips.  The labels (0 thru 3) are added when creating the image.  Explanations for what we found is discussed in section 6.  
